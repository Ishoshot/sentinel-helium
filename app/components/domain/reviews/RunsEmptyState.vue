  ...
  switch (props.type) {
    case 'error':
      return {
        ...
        iconClass: 'flex size-16 items-center justify-center rounded-2xl bg-red-500/10',
    ...
    case 'no-matches':
      return {
        ...
        iconClass: 'flex size-16 items-center justify-center rounded-2xl bg-bg-surface',
  ...
  <div class="py-16 text-center">
    ...
    <div class="mt-6">
      <NuxtLink
        ...
        class="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-accent to-teal-600 px-4 py-2 text-sm font-medium text-white hover:shadow-glow"
      >
        <Icon
      ...
      <button
        ...
        type="button"
        class="inline-flex items-center gap-2 rounded-lg border border-border-subtle bg-bg-elevated px-4 py-2 text-sm font-medium text-text-secondary hover:bg-bg-hover"
